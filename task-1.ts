class Contact {
  ...
  const contact1 = new Contact("John Doe", "johndoe@example.com", "123-456-7890" ,"Work");
  const contact2 = new Contact("Alice Smith", "alice.smith@invalid", "456-789-0123", "Family"); // Invalid email
